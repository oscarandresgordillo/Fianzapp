                        ...
                        if (isset($_GET['error'])) {
                            ...
                            <input type="hidden" name="id_usuario" value="<?php echo $cli->id_usuario; ?>">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                        <button onclick="window.location.href='?c=clientePanel&a=index'" type="button" class="btn btn-block waves-effect" style="border-radius: 10px; font-size: 16px; background-color: #132644; color: #fff;">
