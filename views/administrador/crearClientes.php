                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
							...
							<input type="hidden" name="id_cliente" value="<?php if(isset($cli)){echo $cli->id_cliente;}else{echo "0";}?>">
	                            <div class="row clearfix">
	                                <div class="col-md-4">
	                                    ...
	                                    <div class="input-group">
	                                        ...
	                                        <div class="form-line">
	                                            <input type="text" class="form-control date" placeholder="Nombre Cliente/Empresa" name="nombre_cliente" value="<?php if(!empty($cli->nombre_cliente)) {echo $cli->nombre_cliente;} ?>">
	                                        </div>
	                                    </div>
	                                </div>             
	                                <div class="col-md-4">
	                                    ...
	                                    <div class="input-group">
	                                        ...
	                                        <div class="form-line">
	                                            <input type="text" class="form-control date" placeholder="CC/NIT" name="nit_cliente" value="<?php if(!empty($cli->nit_cliente)) {echo $cli->nit_cliente;} ?>">
	                                        </div>
	                                    </div>
	                                </div>
	                                <div class="col-md-4">
	                            ...
	                            <div class="row clearfix">
	                                ...
	                                <div class="col-md-4">
	                                    ...
	                                    <div class="input-group">
	                                        ...
	                                        <div class="form-line">
	                                            <input type="text" class="form-control date" placeholder="Correo" name="correo_cliente" value="<?php if(!empty($cli->correo_cliente)) {echo $cli->correo_cliente;} ?>">
	                                        </div>
	                                    </div>
	                                </div>
	                                <div class="col-md-4">
	                            ...
	                            <div class="row clearfix">            
	                                <div class="col-md-4">
	                                    ...
	                                    <div class="input-group">
	                                        ...
	                                        <div class="form-line">
	                                            <input type="text" class="form-control date" placeholder="Usuario" name="usuario_cliente" value="<?php if(!empty($cli->usuario_cliente)) {echo $cli->usuario_cliente;} ?>">
	                                        </div>
	                                    </div>
	                                </div>
	                                <div class="col-md-4">
	                                    ...
	                                    <div class="input-group">
	                                        ...
	                                        <div class="form-line">
	                                            <input type="password" class="form-control date" placeholder="Contraseña" name="contrasena_cliente" value="<?php if(!empty($cli->numero_fianza)) echo 'disabled'?>">
	                                        </div>
	                                    </div>
	                                </div>
	                                <div class="col-md-4">
	                                    ...
	                                    <div class="input-group">
	                                        ...
	                                        <div class="form-line">
	                                            <input type="text" class="form-control date" placeholder="Número de fianza" name="fianza" value="<?php if(!empty($cli->numero_fianza)) {echo $cli->numero_fianza;} ?>">
	                                        </div>
	                                    </div>
	                                </div>
	                            </div>
