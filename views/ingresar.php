    ...
    <div class="login-box">
        ...
        <div class="logo">
            ...
            <div class="body">
                ...
                error_reporting(0);
                if($_GET['men']=='mal'){
        echo "<center> <span style='color: red;' > Error en el usuario o contraseña</span></center>";
    }
    ?>
                <form id="" method="post" action="?c=Ingresar&a=Ingresar_usuario">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="usuario" placeholder="Usuario" style="font-size: 16px" require autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
